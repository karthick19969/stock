...
if (isset($_POST['submit'])) {
    ...
    $query = "insert into suppliers(Suppliers_Code,Suppliers_Name,Suppliers_Address,Suppliers_City,Suppliers_State,Suppliers_Pincode,Suppliers_Contact_Number,Suppliers_Email) values('$suppliercode','$suppliername','$supplieraddress','$suppliercity','$supplierstate','$supplierpincode','$suppliercontactnumber','$supplieremail')";
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal">
											...
											<?php
        $max = $db->maxOfAll("Suppliers_Id", "Suppliers");
        $max = $max + 1;
        $autoid = "SUP" . $max . "";
        ?>
                        <label class="col-sm-2 control-label">Supplier
												...
												<div class="col-sm-8">
													<input type="text" readonly="readonly"
														value="<?php echo $autoid; ?>" name="suppliercode"
														class="form-control">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" name="suppliername"
														id="suppliername" value="" required="required">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control"
														name="suppliercontactnumber" value="">
												</div>
											</div>
											<div class="form-group">

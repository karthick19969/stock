...
if (isset($_POST['submit'])) {
    ...
    $a = date('Y-m-d');
    $msg = mysqli_query($con, "insert into users(firstName,middleName,lastName,gender,contactNo,email,password) values('$fname','$mname','$lname','$gender','$contact','$email','$enc_password')");
    if ($msg) {

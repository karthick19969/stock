...
<td><a href="editcustomer.php?id=<?php echo $row->Customer_Id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
<a href="managecustomer.php?del=<?php echo $row->Customer_Id;?>" onclick="return confirm("Do you want to delete");"><i class="fa fa-close"></i></a></td>
										</tr>
									<?php
$cnt=$cnt+1;
									 } ?>
